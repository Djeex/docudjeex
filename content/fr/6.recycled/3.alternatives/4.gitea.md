...
::tip{icon=""}
✨ __Astuce :__ vous pouvez protéger cette application nativement en OIDC avec [Pocket ID](/serveex/security/pocket-id) (en l'enregistrant comme client OIDC), ou avec Authentik en [suivant ces instructions](https://integrations.goauthentik.io/development/gitea/).
::
