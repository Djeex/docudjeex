...
__Attention :__ si votre serveur est hébergé chez vous :
...
- assurez-vous d'avoir [redirigé le port 443 vers le port d'écoute de votre serveur](/general/networking/nat).
::
