...
::note
Cet article a été écrit avant l'augmentation __massive__ des prix du matériel informatique que nous subissons depuis fin 2025. Cependant, en mettant de côté les coûts, il n'en reste pas moins pertinent.
::
...
## OK, mais comment je passe de mon Mini PC Serveex à un ProloNAS ?

Comme dit plus haut, avec un DAS (hub disque) + de quoi faire du [RAID](/general/storage/raid) avec [ZFS](/general/storage/zfs) par exemple.
