...
Nommez la stack authentik et collez la configuration suivante, en changeant les chiffres de `{AUTHENTIK_TAG:-2025.2.1}`{lang=properties} par [la dernière version de Authentik](https://goauthentik.io/docs/releases). 
